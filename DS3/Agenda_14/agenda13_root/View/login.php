...
<head>
    ...
    <style>
        body { background-color: #f0f0f0; display: flex; align-items: center; justify-content: center; height: 100vh; margin: 0; }
    </style>
</head>
<body>

<form action="/agenda13_root/Controller/Navegacao.php" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin w3-display-middle" style="width: 35%;">
    ...
    <!-- Botões Corretos (Sem duplicatas) -->
    <div class="w3-row w3-section">
        <div class="w3-half">
